...
import { pharmacy_categories } from '../../redux/actions/pharmacy_categories';
import { connect } from 'react-redux';


class PharmacyCatagories extends Component {
  ...
  componentDidMount(){
    axios.get('http://backend.bionische.com/api/patient/pharmacy_categories')
      ...
      <>
        <View style={styles.container}>
            ...
            <LinearGradient
              ...
              <View style={styles.upperWrapper}>
                ...
                <View style={styles.imageWrapper}>
                  <Text style={styles.uName}>Pharmacy Categories</Text>
                </View>
          ...
          <View style={styles.topText}>
            <Text style={styles.texthead}>Top Pharmacies</Text>
          </View>
            ...
            <FlatList
              ...
              renderItem={({item}) => (
                <View style={styles.docTypeWrapper}>
                  ...
                  <TouchableOpacity
                    onPress={() =>
                      this.props.navigation.push('Pharmacy', {pharmacy_category:item.id, city:this.props.route.params.city, delivery_type:this.props.route.params.delivery_type})
                    }>
